 ...
 *
 * Notes:
 *   - The decoder handles rate-matching (shortening/puncturing) automatically
 *   - infoout must be large enough for all decoded info bits
 *   - Uses normalized min-sum algorithm (scaling factor 0.75)
 */
